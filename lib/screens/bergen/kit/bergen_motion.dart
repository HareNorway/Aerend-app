...
/// Small CSS-keyframe helpers shared by the Bergen screens (Fjordfiske, Kurv). Both honour
...
class BergenLoop extends StatelessWidget {
  const BergenLoop({
    super.key,
...
class BergenOnce extends StatelessWidget {
  const BergenOnce({
    super.key,
    required this.durationMs,
    required this.builder,
...
/// CSS `cubic-bezier(.34,1.56,.64,1)` (`popp`).
