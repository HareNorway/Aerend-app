...
class ServiceTypeModel {
  ...
  int messageCode = 0;
  String message = "";
  List<ServiceTypeItem> serviceType = [];

  ServiceTypeModel({this.status = 0, this.messageCode = 0, this.message = "", List<ServiceTypeItem>? serviceType}) {
...
/// image : "https://Fox-Delivery-Anything-staging.startuptrinity.com/assets/images/service-category/transport-service-type/145111420200710.png"
/// cost_per_km : 8
/// weight_limit : 0
/// dimension_limit : ""
/// base_fare : 50
...
class ServiceTypeItem {
  ...
  double lengthLimit = 0;
  double baseFare = 0;
  double costPerMin = 0;
  double widthLimit = 0;
  double heightLimit = 0;
  double minFareAmount = 0;
  ...
  ServiceTypeItem({
    ...
    this.widthLimit = 0,
    this.heightLimit = 0,
    this.minFareAmount = 0,
    this.currencyRatio = 0,
  });

  factory ServiceTypeItem.fromJson(Map<String, dynamic> json) => _$ServiceTypeItemFromJson(json);

  Map<String, dynamic> toJson() => _$ServiceTypeItemToJson(this);
}
